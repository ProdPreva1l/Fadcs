...
public enum Config {
    ...
    LOCALE_PREFIX("messages.prefix", "&#d6b11e&lChest Shops &r"),
    LOCALE_NO_PERMISSION("messages.no-permission", "&cYou do not have permission to run this command!"),
    LOCALE_GENERIC_ERROR("messages.generic-error", "&cAn error occurred! &8(&7{0}&8)"),
    ;
